...
class LecturerPolicy
{
    ...
    public function makeUser(User $user, Lecturer $lecturer): bool
    {
        // Tombol hanya aktif jika user yang login adalah admin
        return is_null($user->lecturer); 
        
        // Jika menggunakan spatie/laravel-permission, gunakan:
